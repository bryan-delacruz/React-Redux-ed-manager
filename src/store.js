...
const reducerManager = (state = initialState, action) => {
  ...
  if (action.type === "AGREGAR_TITULAR") {
    return {
      ...
      jugadores: state.jugadores.filter((e) => e.id !== action.jugador.id),
    };
  }
  ...
  if (action.type === "QUITAR_TITULAR") {
    return {
      ...state,
      titulares: state.titulares.filter((e) => e.id !== action.jugador.id),
  ...
  if (action.type === "QUITAR_SUPLENTE") {
    return {
      ...state,
      suplentes: state.suplentes.filter((e) => e.id !== action.jugador.id),
      jugadores: state.jugadores.concat(action.jugador),
    };
  }
  return state;
